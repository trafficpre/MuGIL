...
def parse_args(parser):
    ...
    parser.add_argument('--epochs', default=100, type=int, help='training epochs')    # 100
...
if __name__ == "__main__":
    ...
    params.arch = 'MMoE_PEMS'  #'MMoE_NYC'   'HPS'   'MMoE_PEMS'
    # params.input_size = {'pems03': [12, 358], 'pems04': [12, 307], 'pems07':[12,883], 'pems08':[12, 170]}
    params.input_size = {'pems03': [12, 307], 'pems04': [12, 307], 'pems07': [12, 170], 'pems08': [12, 170]}
