...
def prepare_args(params):
    ...
    if params.arch in ['HPS', 'Cross_stitch', 'MTAN', 'CGC', 'PLE', 'MMoE', 'DSelect_k', 'DIY', 'LTB', 'MMoE_NYC', 'MMoE_PEMS', 'MMoE_Traffic', 'MMoE_Traffic_nyc', 'MMoE_Traffic_sh', 'MTformer']:
        ...
        if params.arch in ['MMoE_NYC']:
            kwargs['arch_args']['input_size'] = params.input_size
            kwargs['arch_args']['num_experts'] = [int(num) for num in params.num_experts]
        if params.arch in ['MMoE_PEMS', 'MMoE_Traffic', 'MMoE_Traffic_nyc', 'MMoE_Traffic_sh', 'MTformer']:
            kwargs['arch_args']['input_size'] = params.input_size
            kwargs['arch_args']['num_experts'] = [int(num) for num in params.num_experts]
    else:
